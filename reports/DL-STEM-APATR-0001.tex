...
\begin{figure}[htbp]
    ...
    \end{minipage}
    \caption{SAM2 SOT results on BIRDSAI sequence \texttt{0000000352} (animal category).
             Top row: sequence 1 segments 143--205 frame 0, 2198--2265 frame 10, and 3147--3208 frame 1.
             Bottom row: sequence 2 segment 482--599 frame 37, and segment 2540--2810 frame 34.
             Bounding box colours: \textcolor{orange}{orange} = ground-truth box;
             \textcolor{green!70!black}{green} = predicted box with IoU $\geq 0.5$ (true positive);
             \textcolor{blue}{blue} = predicted box with IoU $< 0.5$ (false positive).}
