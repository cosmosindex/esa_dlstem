...
\paragraph{OOTB.}
On the OOTB traffic dataset (Tables~\ref{tab:sot-overall} and~\ref{tab:sot-ootb}), SAM2 exhibits pronounced variation across categories,
