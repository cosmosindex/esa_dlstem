...
def get_args_parser():
    ...
    # split dir under --mot_path that datasets/dance.py globs for training videos.
    # Default keeps upstream DanceTrack behaviour; the satellite union sets it to
    # the export produced by tools/export_motrv2.py (e.g. "train").
    parser.add_argument('--mot_train_name', default='DanceTrack/train', type=str)
