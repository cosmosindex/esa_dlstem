...
| [`evaluation/`](evaluation/) | one runner per benchmarked method |
...
The benchmark is released under **CC BY-NC-SA 4.0**. Redistribution permission
was obtained for every source dataset; per-source terms are in
[`DATASETS.md`](DATASETS.md). The code in this repository is released for
research use alongside it.
